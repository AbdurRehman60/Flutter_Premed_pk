    ...
    try {
      ...
      if (success) {
        ...
        if (engineeringQBankCategory != null) {
          final List<dynamic> deckGroupsData =
              engineeringQBankCategory['deckGroups'];
          _deckGroups = deckGroupsData
              .map((deckGroupData) {
                ...
                final List<DeckItem> deckItems = decks.where((deck) {
                  ...
                  final List<dynamic>? premiumTagsJson =
                      deck['premiumTags'] as List<dynamic>?;
              ...
              .where((deckGroup) => deckGroup != null)
              .cast<DeckGroupModel>()
              .toList();
