...
class EstuffPdfView extends StatefulWidget {
  const EstuffPdfView(
      {super.key, required this.essenceStuffModel, required this.categoryName});
  final EssenceStuffModel essenceStuffModel;
  final String categoryName;

  @override
  State<EstuffPdfView> createState() => _EstuffPdfViewState();
}

class _EstuffPdfViewState extends State<EstuffPdfView> {
  int currentPage = 0;
  int maxPage = 0;
            ...
            children: [
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: widget.essenceStuffModel.pagination?.length,
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                widget
                                    .essenceStuffModel.pagination![index].name,
