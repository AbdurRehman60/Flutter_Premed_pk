    ...
    return Consumer<CheatsheetsProvider>(
        builder: (context, vaultCheatSheetsProvider, _) {
          final bool isLoading =
              vaultCheatSheetsProvider.vaultnotesLoadingstatus == CheatSheetsFetchStatus.fetching;
          return Scaffold(
            ...
            body: Column(
              ...
              children: [
                ...
                Expanded(
                  child: PdfDisplayer(
                    hasAccess: Provider.of<PreMedAccessProvider>(context, listen: false).hasCheatsheets,
