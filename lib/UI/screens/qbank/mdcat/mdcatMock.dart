...
import '../mdcat_mock_proivder.dart';
import '../widgets/deckgroup_maker.dart';

class MdcatMockHome extends StatefulWidget {
  const MdcatMockHome({super.key});

  @override
  State<MdcatMockHome> createState() => _MdcatMockHomeState();
}

class _MdcatMockHomeState extends State<MdcatMockHome>
        ...
        children: [
          ...
          Expanded(
            child: Consumer<MDCATMocksProvider>(
              builder: (context, mdcatmockpro, _) {
                switch (mdcatmockpro.fetchStatus) {
                  ...
                  case FetchStatus.success:
                    return TabBarView(
                      ...
                      children: [
                        DeckGroupList(
                          deckGroups: mdcatmockpro.deckGroups
                              .where(
